    ...
    for (const proj of projectList) {
      ...
      perProjectItems.push(
        ...
        },
        {
          ...
          description: "Investors pay 3 credits to unlock. Canva, Docsend, Notion, or any view-only link.",
        ...
        },
        {
          ...
          description: "Revenue, burn rate, and runway — investors pay 5 credits to view. Self-reported.",
