      ...
      <div className="mx-auto max-w-4xl space-y-10 px-[5%] py-10">
        ...
        <section>
          ...
          {upcoming.length === 0 ? (
            ...
            <div className="flex gap-4 overflow-x-auto pb-3 -mx-[5%] px-[5%] snap-x snap-mandatory">
            {upcoming.map((event) => {
                    ...
                    <div className="mt-auto pt-5 flex flex-wrap gap-3">
                      {event.registered ? (
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-2 rounded-xl bg-(--color-primary) px-5 py-2.5 text-sm font-bold text-white hover:opacity-90 disabled:opacity-50 transition-opacity"
                        >
                          {isRsvping ? (
                            <>
