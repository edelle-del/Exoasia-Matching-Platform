...
const CREDIT_COSTS: {
  ...
  href: string;
    ...
    },
    {
      ...
      reason: "Initiating a formal, managed introduction request applies a warm platform vouch and surfaces your venture parameters directly to an investor's board. Free tier accounts are subject to weekly outreach limits; exceeding this limit invokes a 3-credit High-Value Outreach Fallback.",
      includedWithPlan: true,
      roles: ["startup"],
      href: "/matches",
    },
